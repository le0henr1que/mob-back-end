...
const ratingListByLocalUseCase = new RatingListByLocalUseCase(PrismaRatingListRepository);

const ratingListByLocalController = new RatingListByLocalController(ratingListByLocalUseCase);
